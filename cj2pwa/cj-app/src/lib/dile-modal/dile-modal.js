...
export class DileModal extends LitElement {
  ...
  open() {
    ...
    document.body.querySelector("#bgModal").style.background='rgba(0,0,0,0.8)';
    document.body.querySelector("cj-app").style.background='rgba(0,0,0,0)';
    document.body.querySelector("cj-app").style.border='0px';
  }
  ...
  close() {
    ...
    document.body.querySelector("#bgModal").style.background='rgba(0,0,0,0)';
    document.body.querySelector("cj-app").style.background='rgba(255,255,255,0.7)';
    document.body.querySelector("cj-app").style.border='1px solid #666666';
